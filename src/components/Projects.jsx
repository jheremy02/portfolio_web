...
function Projects() {
  ...
  return (
    <section id="proyects" className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 mt-12 justify-center text-center sm:mt-16 gap-x-4 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {projects.map((project, idx) => (
            <div key={idx} className="flex justify-center">
              <div

                className="   max-w-sm flex gap-4 flex-col justify-between  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 "
              >
                ...
                */}
                ...
                <div className="p-5 flex flex-col justify-between flex-grow">
                  ...
                  <div className="flex self-end mt-6">
                    ...
                    {project.links.demo && <Link to={project.links.demo} target="_blank" rel="noopener noreferrer">
                      <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Demo</button>
                    </Link>}
                  </div>
                </div>
              </div>
